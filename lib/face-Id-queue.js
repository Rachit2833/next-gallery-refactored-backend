...
const { connectDb } = require('../next-gallery-refactored-backend/lib/connectDb.js');
const Label = require('../next-gallery-refactored-backend/Schema/labelSchema.js');
const SchemaImage = require('../next-gallery-refactored-backend/Schema/imageSchema.js');
const { blurQueue } = require('../next-gallery-refactored-backend/lib/blur-queue.js');

const connection = require("../next-gallery-refactored-backend/lib/redis-clinet.js"); // Not called here
